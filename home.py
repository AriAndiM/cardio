...
with st.container():
    ...
    if choose == "Home":
        ...
        st.markdown('<h1 style = "text-align: center;"> Fitur Dataset: </h1><ol type = "1" style = "text-align: justify; background-color: #f2a916; padding: 30px; border-radius: 20px;"><li>**_Age_** merupakan umur dari pasien yang diukur dalam satuan hari dengan tipe data int.</li><li>**_Height_** merupakan tinggi badan dari pasien dalam satuan cm yang diukur menggunakan alat stature meter dengan tipe data integer.</li><li>**_Weight_** merupakan berat badan dari pasien dalam satuan kg yang diukur menggunakan alat timbangan injak dengan tipe data float.</li><li>**_Gender_** merupakan jenis kelamin dari pasien. Jenis kelamin bertipe biner yaitu perempuan dan laki-laki.</li><li>**_Systolic blood pressure (tekanan darah sistolik)_** merupakan tekanan ketika jantung pasien memompa darah ke seluruh tubuh .Tekanan darah sistolik dapat diukur menggunakan alat tensimeter.</li><li>**_Diastolic blood pressure (tekanan darah diastolik)_** merupakan tekanan ketika darah masuk ke dalam jantung. Tekanan darah diastolik dapat diukur menggunakan alat tensimeter.</li><li>**_Cholesterol (kolesterol)_** merupakan lemak mirip zat lilin yang terdapat dalam darah pasien. Kolesterol dapat diketahui dengan cara melakukan pemeriksaan ke rumah sakit atau puskesmas terdekat Terdapat 3 tingkatan kolesterol yaitu 1: normal yaitu kadar kolesterol < 200 (mg/dL), 2: di atas normal yaitu kadar kolesterol antara 200 s/d 239 (mg/dL), 3: jauh di atas normal yaitu kadar kolesterol > 240 (mg/dL).</li><li>**_Glucose_** (glukosa) merupakan senyawa organik dalam bentuk karbohidrat berjenis monosakarida. Kadar glukosa dapat diukur di laboratorium atau dengan alat glukometer. 1 : Glukosa normal kadarnya sekitar 100 - 160 mg/dL, 2 : Glukosa diatas normal kadarnya sekitar 160 - 240 mg/dL, 3 : Glukosa jauh diatas normal kadarnya di atas 240 mg/dL.</li><li>**_Smoking_** merupakan kondisi pasien sedang merokok atau tidak</li><li>**_Alcohol_** intake merupakan kondisi pasien apakah mengkonsumsi alkohol atau tidak.</li><li>Physical activity merupakan kondisi pasien apakah aktif berolahraga atau tidak.</li><li>**_Presence_** or absence of cardiovascular disease merupakan hasil diagnosa apakah pasien mengidap penyakit cardiovascular.</li></ol>', unsafe_allow_html = True)

    elif choose == "Dataset":
        st.markdown('<h1 style = "text-align: center;">Dataset Cardiovascular</h1>', safe_allow_html = True)
        cardio = pd.read_csv('cardiovascular.csv')
        cardio

    elif choose == "Preprocessing":
        st.markdown('<h1 style = "text-align: center;">Preprocessing</h1>', safe_allow_html = True)
        ...
        if pilih_model == 'Gausian Naive Bayes':
            ...
            if cek:
                st.markdown('<h5 style = "color: black;"> <b>Hasil Diagnosa<b> </h5>', unsafe_allow_html = True)
                gnb = GaussianNB()
