...
with st.container():
    ...
    if choose == "Home":
        ...
        # form data kesehatan
        st.markdown('<h1 style = "text-align: center; color: #eb2e10;"> Prediksi Cardiovascular Diseases </h1><h3 style = "text-align: center; color: orange;"> Masukkan Data Kesehatan Anda </h3>', unsafe_allow_html = True)
        #dataset
